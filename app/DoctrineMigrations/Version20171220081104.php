 ...
 */
class Version20171220081104 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE projects (id INT AUTO_INCREMENT NOT NULL, slider_small_image_id INT DEFAULT NULL, slider_large_image_id INT DEFAULT NULL, header_background_image_id INT DEFAULT NULL, description_background_image_id INT DEFAULT NULL, stripe_background_image_id INT DEFAULT NULL, form_background_image_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, is_in_slider TINYINT(1) NOT NULL, slider_annotation VARCHAR(255) NOT NULL, slider_description LONGTEXT NOT NULL, video_embed_url LONGTEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, members VARCHAR(255) NOT NULL, place VARCHAR(255) NOT NULL, movement_type VARCHAR(255) NOT NULL, duration VARCHAR(255) NOT NULL, gadget VARCHAR(255) NOT NULL, age VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, color VARCHAR(255) NOT NULL, sort_order INT DEFAULT NULL, UNIQUE INDEX UNIQ_5C93B3A4989D9B62 (slug), INDEX IDX_5C93B3A4BA8A7AC0 (slider_small_image_id), INDEX IDX_5C93B3A4B4A4D823 (slider_large_image_id), INDEX IDX_5C93B3A4EA8139B4 (header_background_image_id), INDEX IDX_5C93B3A46A222D67 (description_background_image_id), INDEX IDX_5C93B3A466AFE2A9 (stripe_background_image_id), INDEX IDX_5C93B3A421241CF7 (form_background_image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
