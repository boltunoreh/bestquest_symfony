 ...
 */
class Version20170321115254 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(128) NOT NULL, icon VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_64C19C1989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quest_photo (id INT AUTO_INCREMENT NOT NULL, image_id INT DEFAULT NULL, quest_id INT DEFAULT NULL, INDEX IDX_470A1D843DA5256D (image_id), INDEX IDX_470A1D84209E9EF4 (quest_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quest (id INT AUTO_INCREMENT NOT NULL, slider_small_image_id INT DEFAULT NULL, slider_large_image_id INT DEFAULT NULL, header_background_image_id INT DEFAULT NULL, description_background_image_id INT DEFAULT NULL, stripe_background_image_id INT DEFAULT NULL, form_background_image_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(128) NOT NULL, is_active TINYINT(1) NOT NULL, is_in_slider TINYINT(1) NOT NULL, slider_annotation VARCHAR(255) NOT NULL, slider_description LONGTEXT NOT NULL, description LONGTEXT NOT NULL, reglament VARCHAR(255) NOT NULL, color VARCHAR(255) NOT NULL, icon VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_4317F817989D9B62 (slug), INDEX IDX_4317F817BA8A7AC0 (slider_small_image_id), INDEX IDX_4317F817B4A4D823 (slider_large_image_id), INDEX IDX_4317F817EA8139B4 (header_background_image_id), INDEX IDX_4317F8176A222D67 (description_background_image_id), INDEX IDX_4317F81766AFE2A9 (stripe_background_image_id), INDEX IDX_4317F81721241CF7 (form_background_image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quest_categories (quest_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_B25D4183209E9EF4 (quest_id), INDEX IDX_B25D418312469DE2 (category_id), PRIMARY KEY(quest_id, category_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE quest_photo ADD CONSTRAINT FK_470A1D843DA5256D FOREIGN KEY (image_id) REFERENCES media__media (id)');
        $this->addSql('ALTER TABLE quest_photo ADD CONSTRAINT FK_470A1D84209E9EF4 FOREIGN KEY (quest_id) REFERENCES quest (id)');
        $this->addSql('ALTER TABLE quest ADD CONSTRAINT FK_4317F817BA8A7AC0 FOREIGN KEY (slider_small_image_id) REFERENCES media__media (id)');
        $this->addSql('ALTER TABLE quest ADD CONSTRAINT FK_4317F817B4A4D823 FOREIGN KEY (slider_large_image_id) REFERENCES media__media (id)');
        $this->addSql('ALTER TABLE quest ADD CONSTRAINT FK_4317F817EA8139B4 FOREIGN KEY (header_background_image_id) REFERENCES media__media (id)');
        $this->addSql('ALTER TABLE quest ADD CONSTRAINT FK_4317F8176A222D67 FOREIGN KEY (description_background_image_id) REFERENCES media__media (id)');
        $this->addSql('ALTER TABLE quest ADD CONSTRAINT FK_4317F81766AFE2A9 FOREIGN KEY (stripe_background_image_id) REFERENCES media__media (id)');
        $this->addSql('ALTER TABLE quest ADD CONSTRAINT FK_4317F81721241CF7 FOREIGN KEY (form_background_image_id) REFERENCES media__media (id)');
        $this->addSql('ALTER TABLE quest_categories ADD CONSTRAINT FK_B25D4183209E9EF4 FOREIGN KEY (quest_id) REFERENCES quest (id)');
        $this->addSql('ALTER TABLE quest_categories ADD CONSTRAINT FK_B25D418312469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE quest_photo DROP FOREIGN KEY FK_470A1D843DA5256D');
        $this->addSql('ALTER TABLE quest DROP FOREIGN KEY FK_4317F817BA8A7AC0');
        $this->addSql('ALTER TABLE quest DROP FOREIGN KEY FK_4317F817B4A4D823');
        $this->addSql('ALTER TABLE quest DROP FOREIGN KEY FK_4317F817EA8139B4');
        $this->addSql('ALTER TABLE quest DROP FOREIGN KEY FK_4317F8176A222D67');
        $this->addSql('ALTER TABLE quest DROP FOREIGN KEY FK_4317F81766AFE2A9');
        $this->addSql('ALTER TABLE quest DROP FOREIGN KEY FK_4317F81721241CF7');
        $this->addSql('ALTER TABLE fos_user_user_group DROP FOREIGN KEY FK_B3C77447FE54D947');
        $this->addSql('ALTER TABLE fos_user_user_group DROP FOREIGN KEY FK_B3C77447A76ED395');
        $this->addSql('ALTER TABLE quest_categories DROP FOREIGN KEY FK_B25D418312469DE2');
        $this->addSql('ALTER TABLE quest_photo DROP FOREIGN KEY FK_470A1D84209E9EF4');
        $this->addSql('ALTER TABLE quest_categories DROP FOREIGN KEY FK_B25D4183209E9EF4');
        ...
        $this->addSql('DROP TABLE quest_photo');
        $this->addSql('DROP TABLE quest');
        $this->addSql('DROP TABLE quest_categories');
