...
},{"./debug":327,"_process":330}],327:[function(require,module,exports){
...
},{"./constants/PlayerStates":334}],333:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./FunctionStateMap":332,"./eventNames":335,"./functionNames":336,"debug":326}],334:[function(require,module,exports){
"use strict";
...
module.exports = exports['default'];
},{"./YouTubePlayer":333,"./loadYouTubeIframeApi":338,"sister":331}],338:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"load-script":328}],339:[function(require,module,exports){
'use strict';
...
var _videoGal = require('./modules/video-gal');

var _videoGal2 = _interopRequireDefault(_videoGal);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.videoGallery = _videoGal2.default;

},{"./modules/video-gal":340,"babel-polyfill":1}],340:[function(require,module,exports){
'use strict';
...
var VideoGallery = function () {
    function VideoGallery(config) {
        _classCallCheck(this, VideoGallery);

        this.$root = $('' + config.$root);
        this.$item = $('' + config.$item);
        this.$arrow = $('' + config.$arrow);
        this.clsActiveItem = config.clsActiveItem;
        this.videoId = config.videoId;
        this.videoContainers = [];
        this.ytAPIOptions = config.ytAPIOptions || {};
    }

    _createClass(VideoGallery, [{
        key: 'videoPackInit',
        value: function videoPackInit() {
            var _this = this;

            this.$item.each(function (i, elem) {
                var id = $(elem).data('primary') ? $(elem).attr('id') : $(elem).find('[data-primary]').attr('id') ? $(elem).find('[data-primary]').attr('id') : null;

                if (id) {
                    var options = {};
                    options.videoId = _this.videoId[i];
                    options.width = 720;
                    options.height = 300;
                    options.playerVars = _this.ytAPIOptions;

                    var player = (0, _youtubePlayer2.default)(id, options);
                    player.id = i;
                    _this.videoContainers.push(player);
                }
            });
        ...
        key: 'startActiveVideo',
        value: function startActiveVideo() {
          var that = this;
          setTimeout(function(){

            var elem = that.$item.filter(function (i, elem) {
              return $(elem).closest('.item').hasClass(that.clsActiveItem);
            });
